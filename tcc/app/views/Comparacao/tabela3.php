<div id="tabela">
    <table class="ui small green table">
        ...
        <tr>
            ...
            <?php $melhorAno = ano($auto1->getAno(), $auto2->getAno(), $auto3->getAno()); ?>
        ...
        <tr>
            ...
            <?php $melhorPot = potencia($auto1->getPotencia(), $auto2->getPotencia(), $auto3->getPotencia());
        ...
        <tr>
            ...
            <?php $melhorPort = portas($auto1->getPortas(), $auto2->getPortas(), $auto3->getPortas());
        ...
        <tr>
            ...
            <?php $melhorPreco = preco($auto1->getPreco(), $auto2->getPreco(), $auto3->getPreco());
        ...
        <tr>
            ...
            <?php $melhorAlt = altura($auto1->getAltura(), $auto2->getAltura(), $auto3->getAltura());
        ...
        <tr>
            ...
            <?php $melhorCom = comprimento($auto1->getComprimento(), $auto2->getComprimento(), $auto3->getComprimento());
        ...
        <tr>
            ...
            <?php $melhorLar = largura($auto1->getLargura(), $auto2->getLargura(), $auto3->getLargura());
        ...
        <tr>
            ...
            <?php $melhorVel = velocidade($auto1->getVelocidade(), $auto2->getVelocidade(), $auto3->getVelocidade());
        ...
        <tr>
            ...
            <?php $melhorTqc = tq_combustivel($auto1->getTanqueCombustivel(), $auto2->getTanqueCombustivel(), $auto3->getTanqueCombustivel());
        ...
        <tr>
            ...
            <?php $melhorDir = direcao($auto1->getTipDirecao(), $auto2->getTipDirecao(), $auto3->getTipDirecao());
        ...
        <tr>
            ...
            <?php $melhorTpc = tp_combustivel($auto1->getTipCombustivel(), $auto2->getTipCombustivel(), $auto3->getTipCombustivel());
        ...
        <tr>
            <th>Porta malas</th>
            <?php $melhorPor = portaMalas($auto1->getPortaMalas(), $auto2->getPortaMalas(), $auto3->getPortaMalas());
        ...
        <tr>
            ...
            <?php $melhorConu = consumoUrb($auto1->getConsumoUrb(), $auto2->getConsumoUrb(), $auto3->getConsumoUrb());
        ...
        <tr>
            ...
            <?php $melhorConr = consumoRod($auto1->getConsumoRod(), $auto2->getConsumoRod(), $auto3->getConsumoRod());
        ...
        <tr>
            <th>Marcha</th>
            <?php $melhorMar = marchas($auto1->getMarcha(), $auto2->getMarcha(), $auto3->getMarcha());
        ...
        <tr>
            <th>Ocupantes</th>
            <?php $melhorOcu = ocupante($auto1->getOcupantes(), $auto2->getOcupantes(), $auto3->getOcupantes());
