...
<div class="ui middle aligned center aligned grid">
    <div class="column">
        <h2 class="ui teal image header">
            <div class="content">
                <h1 style="color: #ff5627;">Editar Modelo</h1>
            </div>
        </h2>
        <form class="ui large form" style="width: 400px; margin: 0 auto;" method="post" action="?acao=updatemodelo&codigo=<?=$codigo; ?>">
            <div class="ui stacked segment">
                ...
                <div class="ui left icon input">
                    ...
                    <input name="idmodelo" type="text" value="<?= $modelo->getIdmodelo() ?>">
                </div>
                <br>
                <br>
                <!-- Name MODELO input-->
