...
<div style="font-size: 2em" class="left floated">
    <h2>COMPARE OS CARROS AQUI</h2>
        ...
        <form class="ui form large" method="post" action="controladorComparacao.php?acao=">
                <?php
                ...
                <div>
                    ...
                    <div class="ui center aligned segment">
                        <button disabled="true" id="comparar_coches" class="ui orange center aligned button submit">
                            Enviar
                        </button>
                    </div>
                </div>
