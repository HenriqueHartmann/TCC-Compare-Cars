<br>
<br>
<div style="font-size: 2em" class="left floated">
    <h2>COMPARE OS CARROS AQUI</h2>
</div>
        <form class="ui form large" method="post" action="controladorComparacao.php?acao=index">
                <?php
                ...
                ?>
                <div>
                    <div class="ui center aligned four column grid segment">
                        <div class="column">
                            <?php
                        ...
                        <div class="column">
                            ...
                            <select name="modelo3" id="modelo3" class="select-modelo">
                                <option>SSelecione o Modelo:</option>
                            </select>
                    ...
                    <div class="ui center aligned segment">
                        <button disabled="true" id="comparar_coches" class="ui green button submit">
                            Enviar
                        </button>
                    </div>
                </div>
